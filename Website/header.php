...
echo '<li id="active"><a href="direct_admin.php">Directors & Administrators</a></li>';
echo '<li id="active2"><a href="doctors.php">Doctors</a></li>';
echo '<li id="active3"><a href="res_int.php">Residents & Interns</a></li>';
echo '<li id="active4"><a href="nursesup.php">Nurse Shift Supervisor</a></li>';
